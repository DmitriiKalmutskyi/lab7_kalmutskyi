...
const Student = {
    ...
    traits: ["працелюбний", "чесний", "спокійний"], // Додані риси
    ...
    // Метод для додавання нової характеристики
    addTrait(newTrait) {
...
// Виклик методу getTraits та виведення результату
console.log(Student.getTraits()); // Виводить перелік характеристик через кому

// Додавання нової характеристики
Student.addTrait("старанний");
console.log(Student.getTraits()); // Виводить перелік характеристик через кому після додавання нової характеристики
